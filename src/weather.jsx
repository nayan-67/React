...
export default function Weather() {
    ...
    let getData = async (e) => {
        ...
        if (data.cod == '400') {
            ...
            toast.error(`${data.message} Enter Valid City Name`)
            setWdata(undefined)
        } else {
            setWdata(data)
        }
    ...
    return (
        <>
            ...
            <div className='bg-[#b9e4febf] lg:w-[600px] w-[90%] lg:h-[600px] h-[400px] rounded-2xl flex flex-col justify-start items-center absolute top-[55%] left-[50%] transform-[translate(-50%,-50%)] backdrop-blur-xl shadow-[0_0px_35px_#61dafbaa] lg:p-10 p-5 gap-2'>
                ...
                {wdata !== undefined ?
                    <>
                        ...
                        <div className='w-full flex flex-col justify-center items-center gap-3 border-b-2 border-[#242424] pb-5'>
                            <img src={`https://api.openweathermap.org/img/w/${wdata.weather[0].icon}@2x.png`} alt="" className='drop-shadow-[0_0px_35px_#6488b3]' />
                        ...
                        <div className='w-full'>
                            ...
                            <div className='w-full flex justify-between items-center py-5 gap-10'>
                                ...
                                <hr className='w-0.5 h-[50px] bg-[#242424]'/>
                                <span className='w-[50%] flex justify-between items-center'>
